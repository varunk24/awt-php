...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="2apappointment.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Approved Appointments</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h4><b><i class="fa fa-bell fa-fw "></i>Approved Appointments</b></h4>
  </header>
  <div class="w3-container"  style="margin:0.5em;" >
  
    <?php foreach($accept as $apt): ?>
       <div id="items" style="border:solid 2px ;border-radius:10px;padding:2em;margin:2em;min-height:13em">
            <div class="float-end">
                <form method="POST">
                  <button class="btn btn-primary " name="engage" value="engage">Engage ?</button>
                  <br><br>
                  <input type="hidden" name="engid" value="<?php echo $apt['id'] ;?>" >
                  </form>
                </div>
                <div >
                  <h2>Patient Name</h2>
