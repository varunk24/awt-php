...
<header>
  ...
  <h1>Doctors List</h1>
  <?php foreach($displ as $docs): ?>
    <div id="items" style="float:left;width:500px;min-height:700px;height:auto; margin:auto;margin-left:100px; ">
        <h2>Dr. <?php echo $docs['dname'] ; ?></h2>
        <div>
        <?php echo "<img src='uploads/". $docs['doc_img']." ' style='display: block;max-width:240px;max-height:240px;width: auto;height: auto;'>"; ?>
        </div>
        <h3>Hospital Name</h3>
        <small><?php echo $docs['hname']; ?></small>
        <h3>Details</h3>
        <small><?php echo $docs['details']; ?></small>
        <h3>Location</h3>
        <small><?php echo $docs['addrs']; ?></small><br><br>
        <a class="btn btn-primary" href="1bookappointment.php?id=<?php echo $docs['id']; ?>" >Book Appointment</a>
       <br><br>
    </div>
  <?php endforeach; ?>
